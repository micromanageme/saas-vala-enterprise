...
function Page() {
  ...
  if (isLoading) {
    return (
      <AppShell>
        <DashboardSkeleton title="Universal Telemetry Admin" subtitle="Universal telemetry administration workspace" />
      </AppShell>
    );
  }
  ...
  if (error) {
    return (
      <AppShell>
        <DashboardError
          title="Universal Telemetry Admin"
          subtitle="Universal telemetry administration workspace"
          message="We couldn't load Universal Telemetry Admin data. The service may be unavailable or you may not have permission."
          onRetry={() => refetch()}
        />
      </AppShell>
    );
