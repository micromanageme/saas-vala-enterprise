...
function Page() {
  ...
  if (isLoading) {
    return (
      <AppShell>
        <DashboardSkeleton title="Scientific Documentation Lead" subtitle="Scientific documentation workspace" />
      </AppShell>
    );
  }
  ...
  if (error) {
    return (
      <AppShell>
        <DashboardError
          title="Scientific Documentation Lead"
          subtitle="Scientific documentation workspace"
          message="We couldn't load Scientific Documentation Lead data. The service may be unavailable or you may not have permission."
          onRetry={() => refetch()}
        />
      </AppShell>
    );
